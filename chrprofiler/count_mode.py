...
def run():
    # database
    historiy_kw = pd.read_csv(f'{ct.CSV_DIR}/history_devpc_keywords.csv')
    ...
    plt.savefig(f'{ct.FIG_DIR}/keywords_search_count_top20.png', bbox_inches="tight")
    plt.savefig(f'{ct.PDF_DIR}/keywords_search_count_top20.pdf', bbox_inches="tight")
    plt.clf()
